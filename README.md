...
- `report/` — Full thesis report;
- `mdpi-paper/` — The MDPI paper and supporting material, including the code and experimental data used to reproduce the figures presented in the manuscript.
